<x-admin.app >
    ...
    @include('admin.JenisPengaduan.modaltambah')
    @include('admin.JenisPengaduan.modaledit')

    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Data Jenis Pengaduan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Data</a></div>
                    <div class="breadcrumb-item">Jenis Pengaduan</div>
                </div>
            </div>
    ...
    @slot('script')
        @include('admin.jenisPengaduan.script')
        <!-- JS Libraies -->
