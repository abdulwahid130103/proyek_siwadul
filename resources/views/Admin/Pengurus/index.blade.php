<x-admin.app >
    ...
    @include('admin.pengurus.modaldetail')
    @include('admin.pengurus.modalconfirmadmin')
    @include('admin.pengurus.modalconfirmselesai')

    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Pengurus Pengaduan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Pengaduan</a></div>
                    <div class="breadcrumb-item">Pengurus Pengaduan</div>
                </div>
            </div>
