<x-admin.app >
    ...
    @include('admin.history.modaldetail')
    @include('admin.history.modaltambah')
    @include('admin.history.modaledit')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="d-flex justify-content-center align-items-center" style="width: 100%;">
                                                <select class="form-control select2" id="filterStatusPengaduanData">
